...
test('it creates projects', function () {
    ...
    expect($this->endpoint->create($data)->toArray())->toBe(['data' => ['id' => 'project-id']]);
});
...
test('it retrieves projects', function () {
    ...
    expect($this->endpoint->retrieve('project-id', $query)->toArray())->toBe(['data' => ['id' => 'project-id']]);
});
...
test('it updates projects', function () {
    ...
    expect($this->endpoint->update('project-id', $data)->toArray())->toBe(['data' => ['id' => 'project-id']]);
});
...
test('it deletes projects', function () {
    ...
    expect($this->endpoint->delete('project-id')->toArray())->toBe(['deleted' => true]);
});
...
test('it lists project routes', function () {
    ...
    expect($this->endpoint->routes('project-id', $query)->toArray())->toBe(['data' => []]);
});
...
test('it creates project routes', function () {
    ...
    expect($this->endpoint->createRoute('project-id', $data)->toArray())->toBe(['data' => ['id' => 'route-id']]);
});
